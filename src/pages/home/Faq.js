        ...
        <uni-page-body>
          <uni-view data-v-6b62b81d  class="page">
            ...
            <uni-view data-v-6b62b81d  class="content">
              ...
              <uni-view data-v-6b62b81d  class="policy-text">FIREFLY STAR LLC is committed to preventing its services from being used for money laundering or terrorist financing activities. This AML/CFT Policy outlines the compliance principles and preventive measures implemented by FIREFLY STAR LLC to ensure adherence to regulatory requirements.</uni-view>
              <uni-view data-v-6b62b81d  class="policy-mid-title">1. Customer Due Diligence (CDD)</uni-view>
              <uni-view data-v-6b62b81d  class="policy-text">FIREFLY STAR LLC conducts Customer Due Diligence (CDD) to verify customer identities, including:</uni-view>
              ...
              <uni-view data-v-6b62b81d  class="policy-text">FIREFLY STAR LLC identifies risks related to money laundering and terrorist financing by assessing customer backgrounds, transaction patterns, and geographic risks. We adopt a Risk-Based Approach (RBA) to allocate monitoring and compliance resources appropriately.</uni-view>
              <uni-view data-v-6b62b81d  class="policy-mid-title">3. Transaction Monitoring</uni-view>
              <uni-view data-v-6b62b81d  class="policy-text">FIREFLY STAR LLC continuously monitors transactions to identify suspicious activities:</uni-view>
              ...
              <uni-view data-v-6b62b81d  class="policy-text">FIREFLY STAR LLC retains customer information, transaction records, and risk assessments as required by law, ensuring:</uni-view>
              ...
              <uni-view data-v-6b62b81d  class="policy-text">FIREFLY STAR LLC employees receive professional training to identify and report suspicious activities. We designate a Compliance Officer responsible for submitting Suspicious Activity Reports (SARs) to relevant regulatory authorities.</uni-view>
              <uni-view data-v-6b62b81d  class="policy-mid-title">6. Training and Awareness</uni-view>
              <uni-view data-v-6b62b81d  class="policy-text">FIREFLY STAR LLC provides ongoing AML/CFT training for all employees, including:</uni-view>
              ...
              <uni-view data-v-6b62b81d  class="policy-text">FIREFLY STAR LLC has established robust internal control mechanisms to ensure compliance with AML/CFT regulations, including:</uni-view>
              ...
              <uni-view data-v-6b62b81d  class="policy-text">FIREFLY STAR LLC actively cooperates with regulatory authorities, law enforcement agencies, and Financial Intelligence Units (FIUs), sharing necessary information as required by law to combat financial crime.</uni-view>
              <uni-view data-v-6b62b81d  class="policy-mid-title">Conclusion</uni-view>
              <uni-view data-v-6b62b81d  class="policy-text">FIREFLY STAR LLC upholds the highest standards to ensure AML/CFT compliance. Through stringent policies and procedures, we prevent illegal activities and are committed to fostering a safe and transparent financial environment.</uni-view>
            </uni-view>
          </uni-view>
        </uni-page-body>
      </uni-page-wrapper>
