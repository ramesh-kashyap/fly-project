  ...
  return (
    <div class="uni-body pages-user-withdrawal" > <uni-app class="uni-app--maxwidth"><uni-page data-page="pages/user/withdrawal"> 
      ...
      <Link to="/dashboard">
        ...
        <uni-view data-v-53c5f33f="" class="back">
          <img data-v-53c5f33f="" src="/static/img/back.png" alt="" style={{ width: '35px',filter: 'brightness(0) invert(0)' }} /></uni-view>

      </Link>
    </uni-view>
    <uni-view data-v-35b9a113="" data-v-53c5f33f="" class="uni-col uni-col-12" style={{ paddingLeft: '0px', paddingRight: '0px' }}>
      <uni-view data-v-53c5f33f="" class="page-title">Withdrawal</uni-view></uni-view><uni-view data-v-35b9a113="" data-v-53c5f33f="" class="uni-col uni-col-6" style={{ paddingLeft: '0px', paddingRight: '0px' }}>
        <Link to="/Whistory">
      ...
      <uni-view data-v-53c5f33f="" class="content">
        ...
        <uni-view data-v-53c5f33f="" class="input-layer" style={{ marginTop: '10px' }}>
          ...
          <div class="uni-input-wrapper">
            ...
            <input disabled="disabled" maxlength="140" step="" enterkeyhint="done" autocomplete="off" value={selectedWallet} readOnly type="" class="uni-input-input" />
          </div>
